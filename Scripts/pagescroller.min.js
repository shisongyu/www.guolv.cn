    ...
    c.fn.extend({
        pageScroller: function(f) {
            ...
            pageScroll = function(d, a) {
                c.fx.interval = 5;
                d.append('<ul class="pageScroll" style="display:none;"></ul>');
                ...
                pageScroller.scrollWindow.scroll(function() {
                		if (pageScroller.sections.eq(0).offset().top < (pageScroller.scrollPosition+30) && 
                				pageScroller.sections.eq(pageScroller.sections.length-1).offset().top > (pageScroller.scrollPosition+30)){
                        	$('.pageScroll').fadeIn();
                        }else{$('.pageScroll').fadeOut();}
                    h();
                });
                setTimeout(function() {
